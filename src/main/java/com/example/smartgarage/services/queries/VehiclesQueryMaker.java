...
//    public String buildHQLSearchAndSortQueryVehicles(
//       //     Optional<String> model, Optional<String> brand,
...
//        }
//
////        if (brand.isPresent() || creationYearMin.isPresent() || creationYearMax.isPresent()) {
////            queryBuilder.append("WHERE ");
////
////            if (brand.isPresent()) {
////                queryBuilder.append("brand LIKE :brand AND ");
...
////            }
////
////            queryBuilder.setLength(queryBuilder.length() - 12);
////        }
//
//        if (sortBy.isPresent()) {
