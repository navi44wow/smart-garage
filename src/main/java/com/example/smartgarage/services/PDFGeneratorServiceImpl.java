...
public class PDFGeneratorServiceImpl implements PDFGeneratorService {
    public void export(HttpServletResponse response, Visit visit) throws IOException {
        ...
        Paragraph username = new Paragraph("Customer: "+visit.getVehicle().getUser().getUsername(), fontDetails);
        Paragraph vehicle = new Paragraph("Vehicle: " + "\n" +
                ...
                "Licence plate: " + visit.getVehicle().getLicensePlate(), fontDetails);
        Paragraph services = new Paragraph("Services: " + "\n" +
                visit.displayServices(), fontDetails);
        ...
        Paragraph bottom = new Paragraph("\"Thank you for choosing us! " +"\n" +
                ...
                "We appreciate your business and look forward to serving you again soon.", bottomText);
