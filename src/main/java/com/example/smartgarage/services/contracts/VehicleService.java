...
public interface VehicleService {
    ...
    List<Vehicle> findAllByModelId(CarModel carModel);

    List<Vehicle> getByUserId(User userId);

    List<Vehicle> searchAllByModelId(CarModel carModel);
    ...
    <T> List<Vehicle> getAllGenericVehicles(Optional<T> brand,Optional<T> model,Optional<T> user,Optional<T> creationYearMin,Optional<T> creationYearMax, Optional<T> sortBy, Optional<T> sortOrder);
